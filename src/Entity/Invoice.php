...
class Invoice
{
     ...
     * @Groups({"invoices_read", "customers_read"})
     * @Assert\NotBlank(message="Montant de la facture obligatoire")
     ...
     * @Groups({"invoices_read", "customers_read"})
     * @Assert\NotBlank(message="Chrono nécessaire.")
     * @Assert\Type(type="integer", message="Le chrono doit être un nombre")
     */
    private $chrono;

    /**
     * Permer de récupérer le user à qui appartient la facture
     * @Groups({"invoices_read"})
     * @return User
     */
